...
public interface NativeClingo extends Library {
	// for later use: (Platform.isWindows() ? "msvcrt" : "c")
	NativeClingo INSTANCE = Native.load("d:\\js\\projects\\clingo4j\\windows\\x64\\clingo.dll", NativeClingo.class);
